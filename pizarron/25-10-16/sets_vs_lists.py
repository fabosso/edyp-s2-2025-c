...
def demo_visualizacion_complejidad():
    ...
    tamanios = [1_000, 5_000, 10_000, 50_000, 100_000, 10_000_000]
    ...
    for tamanio in tamanios:
        ...
        print(
            f"{tamanio:>10,}     {tiempo_lista*1000:8.2f}       {tiempo_set*1000:8.2f}        {mejora:>6.0f}x"
        )
...
def main():
    ...
    # print("╔" + "═" * 68 + "╗")
    # print(
    #     "║" + " " * 15 + "DEMOSTRACIÓN DE EFICIENCIA: SETS vs LISTAS" + " " * 12 + "║"
    # )
    # print("╚" + "═" * 68 + "╝")
